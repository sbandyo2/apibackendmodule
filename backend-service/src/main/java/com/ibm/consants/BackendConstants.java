...
public class BackendConstants {
	...
	public static final String YP_APP_TYPE ="YP";
	public static final String CSA_APP_TYPE ="CSA";
	public static final String ON_APP_TYPE ="ON";
	...
	public static final String CLOUDANT_VIEW_01 = "views01";
